...
list h multlin1 multlin2 multrec1 multrec2 multexp1 multexp2  if h<=20;
outsheet h multlin1 multrec1 multexp1 using junk1step.csv if h<=20, comma replace ;

display as text "Multipliers and corresponding standrad errors: Linear, Expansion, Recession";

list h multlin1 seylin multrec1 seyrec multexp1 seyexp ptestdiff if h<=20;
outsheet h multlin1 seylin multrec1 seyrec multexp1 seyexp ptestdiff using junkmultse.csv if h<=20, comma replace ;
